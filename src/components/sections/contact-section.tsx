...
const ContactMe = () => {
  ...
  return (
    <div className="mt-24 w-full min-h-[100vh] h-full">
      <div className="flex flex-col gap-y-2 items-center">
        ...
        <div className="flex flex-col md:flex-row  items-start justify-between w-[80%] md:w-[60%] bg-transparent rounded-[10px] hover:bg-[#161f33] hover:shadow-xl transition-all  mt-5 p-10 group">
